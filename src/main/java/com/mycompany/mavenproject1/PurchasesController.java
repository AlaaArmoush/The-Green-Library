...
public class PurchasesController {
    ...
    void removePurchase(ActionEvent event) {
        try {
            ...
            if (selectedPurchase != null) {
                ...
                JOptionPane.showMessageDialog(null, "Please select a purchase from the table.");
            }
    ...
    // Define a method to handle the addition of a new purchase
    @FXML
    void addPurchase(ActionEvent event) {
        try {
            ...
            // Refresh the table after adding a new purchase
            initialize();

        } catch (IOException e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "An error occurred while opening the add purchase window. Please try again later.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
